...
: dawn::system([](dawn::entity& entity)
	{
		return entity.has_component<render_component>() && entity.has_component<physical_component>();
	}),
...
void render_system::update_entity(dawn::entity& entity)
{
	entity.get_component<render_component>().sprite.setPosition(
		entity.get_component<physical_component>().x,
		entity.get_component<physical_component>().y
	);
